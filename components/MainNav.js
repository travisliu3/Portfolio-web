        ...
        <>
            <nav id="sidebar" class={sidebarActive ? 'active' : ''}>
                ...
                <Container>
                    ...
                    <Row>
                        <Nav className={`${'/about' === path ? "fw-bold me-auto" : "me-auto"}`}>
                            <motion.div
                                whileHover={{ scale: 1.1 }}
                            >
                    ...
                    <Row>
                        <Nav className={`${'/work' === path ? "fw-bold me-auto" : "me-auto"}`}>
                            <motion.div
                                whileHover={{ scale: 1.1 }}
                            >
                    ...
                    <Row>
                        <Nav className={`${'/project' === path ? "fw-bold me-auto" : "me-auto"}`}>
                            <motion.div
                                whileHover={{ scale: 1.1 }}
                            >
